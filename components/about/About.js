  ...
  return (
    <div className="containAbout" id="about" style={{ overflow: "hidden" }}>
      ...
      <div className="container containerEditMax">
        ...
        <div
          className="row"
          style={{ overflow: "hidden", position: "relative", zIndex: "123" }}
        >
          <motion.div
            ref={ref}
            ...
            <div className="col-sm-12 col-lg-6 aboutTxt">
              {LangId === "fa" ? (
                <p style={stylee} className="fa-about">
                  افتخار بسیاری نظیر گواهی ثبت اختراع به شماره، ۶۸۳۴۰ عضویت
                  بنیاد ملی نخبگان و دریافت گواهی شرکت دانش بنیان از معاونت علمی
                  و پژوهشی ریاست جمهوری، دریافت مجوز بند ب از وزارت میراث
                  فرهنگی، گردشگری و صنایع دستی و همینطور مفتخر به دریافت عنوان
                  فناور برتر گردیده است. این هلدینگ به منظور توسعه فعالیت خود در
                  سطح بین الملل اقدام به راه اندازی نخستین دفتر خود رد خارج از
                  مرزهای ایران کرده و در سال ۲۰۱۸ اقدام به ایجاد شعبه در کشور
                  استونی و در شهر تالین تحت عنوان تجارت الکترونیک زوناکس کرد.
                  شرکت های تابعه این هلدینگ پروژه ها و محصولات بسیاری را در حوزه
                  فناوری اطلاعات و ارتباطات تا کنون طراحی، اجرا و روانه بازار
                  کرده و اقدامات موثر بسیاری نیز در خصوص هوشمند سازی سازمان ها
                  توسط این مجموعه صورت پذیرفته است.
                </p>
              ) : (
            ...
            <div className="col-sm-12 col-lg-6 aboutTxt">
              {LangId === "fa" ? (
                <p style={stylee} className="fa-about">
                  ...
                  برداشته است و در این راه موفق به دریافت مجوز ها، استاندارد ها
                  و تندیس های
                </p>
              ) : (
                <p style={stylee} className="en-about EN-FONT">
          ...
          <div className="col-12 contain2colAboutSm">
            {LangId === "fa" ? (
              <p style={stylee} className="fa-about">
                هلدینگ بین‌المللی تجارت الکترونیک پرهام کیش، یک مجموعه متشکل از
                چندین شرکت فعال در حوزه فناوری اطلاعات و ارتباطات بوده ودرزمینه
                ...
                بسترهای ارتباطی با مخاطبان ومشتریان با شیوه های نوین
                ارتباطی‌تعاملی فعالیت می نماید. این مجموعه فعالیت خود را از سال
                ۱۳۸۸ با نام تجارت الکترونیک پرهام در جزیره کیش آغاز کرده و پس از
                گذشت بیش یک دهه از فعالیت آن امروزه به عنوان یک هلدینگ پیشرو در
                فناوری اطلاعات و ارتباطات در سطح بین الملل شناخته می شود. پرهام
                کیش در حوزه تجارت الکترونیک و فناوری اطلاعات و ارتباطات گام های
                بلند و مثبتی برداشته است و در این راه موفق به دریافت مجوز ها،
                استاندارد ها و تندیس های افتخار بسیاری نظیر گواهی ثبت اختراع به
                شماره، ۶۸۳۴۰ عضویت بنیاد ملی نخبگان و دریافت گواهی شرکت دانش
                بنیان از معاونت علمی و پژوهشی ریاست جمهوری، دریافت مجوز بند ب از
                وزارت میراث فرهنگی، گردشگری و صنایع دستی و همینطور مفتخر به
                دریافت عنوان فناور برتر گردیده است. این هلدینگ به منظور توسعه
                فعالیت خود در سطح بین الملل اقدام به راه اندازی نخستین دفتر خود
                رد خارج از مرزهای ایران کرده و در سال ۲۰۱۸ اقدام به ایجاد شعبه
                در کشور استونی و در شهر تالین تحت عنوان تجارت الکترونیک زوناکس
                کرد. شرکت های تابعه این هلدینگ پروژه ها و محصولات بسیاری را در
                حوزه فناوری اطلاعات و ارتباطات تا کنون طراحی، اجرا و روانه بازار
                کرده و اقدامات موثر بسیاری نیز در خصوص هوشمند سازی سازمان ها
                توسط این مجموعه صورت پذیرفته است.
              </p>
            ) : (
