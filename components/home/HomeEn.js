      ...
      <div style={stylee}>
        <div className="backgroundImageHeader">
          <div className="container" style={{ color: "red" }}>
            <div className="containBlackImage containBlackImageEn" style={containBlackImageSty}>
              ...
              <div className="containCount" style={containCountSty}>
                  ...
                  >
                    <h1 className="totalnumslide" id="totalnumslideId" style={containCounthSty}>
                      0{Count}
                    </h1>
