        ...
        <div className="cont row">
          ...
          <div className="row col-xs-12 col-lg-8 containInput">
            ...
            <div className="responsive-kadr">
              ...
              {LangId === "fa" ? (
                <div className="col-6-create paddingrightget pr2">
                  <input type="tel" placeholder="موبایل *" required style={styleef} />
                </div>
              ) : (
                <div className="col-6-create paddingrightget2">
                  <input type="tel" placeholder="PhoneNumber* " required style={styleef} />
                </div>
              )}
            </div>
            ...
            <div className="responsive-kadr">
              {LangId === "fa" ? (
                ...
                <div className="col-12 col-12-create">
                  <textarea required type="text" placeholder="*Message Text  " style={styleef} className="messageTxt"/>
                </div>
              )}
