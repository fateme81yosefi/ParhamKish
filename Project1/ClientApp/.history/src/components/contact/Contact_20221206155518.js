            ...
            <div className="responsive-kadr">
              ...
              <div className="col-6-create">
                {LangId === "fa" ? (
                  <input
                    type="text"
                    className="paddingrightget"
                    placeholder="نام خانوادگی"
                    style={styleef}
                  />
                ) : (
                  <input type="text" placeholder="last name " className="paddingrightget" style={styleef} />
                )}
              </div>
              <div className="col-6-create">
                {LangId === "fa" ? (
                  <input type="text" placeholder="نام " className="paddingrightget" style={styleef} />
                ) : (
                  <input type="text" placeholder="Name " className="paddingrightget" style={styleef} />
                )}
              </div>
            </div>
            <div className="col-6-create">
