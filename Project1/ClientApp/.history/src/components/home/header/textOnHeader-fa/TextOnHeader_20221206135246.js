  ...
  return (
    ...
    >
      {LangId === "fa" ? (
       ...
       iteration="1"
       fillMode="none">
          <h1 style={stylee} className="parhamTitle1">هلدینگ دانش بنیان پرهام کیش</h1>
          <h1 style={stylee}>هلدینگ دانش بنیان پرهام کیش</h1>
      ...
      iteration="1"
      fillMode="none">
        <h2 style={stylee}>هلدینگ دانش بنیان پرهام کیش</h2>
        </MovingComponent>
