    ...
    <div style={stylee}>
      <div className="backgroundImageHeader">
        <div className="container" style={{ color: "red" }}>
          <div className="containBlackImage" style={containBlackImageSty}>
            <img
              alt="backCounter"
            ...
            <div className="containCount" style={containCountSty}>
              {LangId === "en" ? (
                <div className="containerInCount">
                  ...
                  <h1 className="totalnumslide" style={containCounthSty}>
                    0{Count}
                  </h1>
                </div>
              ) : (
                <div className="containerInCount">
                  <h4 className="currslide" style={{marginLeft:"12px"}}>/05</h4>
                  <h1 className="totalnumslide">0{Count}</h1>
                </div>
              )}
            </div>
          </div>
          ...
          <div className="black" style={blackSty}>
            {LangId === "fa" ? (
              <p>گروه شرکت های پرهام کیش</p>
            ) : (
              <p> Parham Kish group of companies </p>
            )}
            ...
            {LangId === "fa" ? (
              ...
              <div
                className="whiteline"
                style={{ marginRight: "50%", marginTop: "29vh" }}
              ></div>
            )}
            ...
            <FaTelegramPlane/>
              ...
              <svg
                onClick={https://www.instagram.com/parhamkish.ir/</div>}
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
                viewBox="0 0 24 24"
      ...
      {/* {LangId === "fa" ? <TextOnHeader /> : <TextOnHeader1 />} */}
